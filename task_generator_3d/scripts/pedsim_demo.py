...
ped_2 = get_default_ped(
    id=2,
    ped_type="adult",
    yaml_path=get_yaml_path_from_type("adult"),
    pos=Point(0.0, 0.0, 0.1),
    waypoints=[Point(-0.4, -7.5, 0.1), Point(-4.0, -1.0, 0.1),
               Point(-4, 9.2, 0.1)]
)
ped_2.number_of_peds = 3
ped_2.requesting_service_probability = 0.005
ped_2.requesting_follower_probability = 0
ped_2.requesting_guide_probability = 0
ped_2.group_talking_base_time = 20.0
peds.append(ped_2)
# # forklift
# ped = get_default_ped(
#     id=2,
...
# respawn_interactive_obstacles_client = rospy.ServiceProxy(
